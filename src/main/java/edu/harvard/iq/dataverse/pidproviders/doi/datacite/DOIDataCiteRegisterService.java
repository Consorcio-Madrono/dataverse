...
public class DOIDataCiteRegisterService {
    ...
    Map<String, String> getMetadata(String identifier) throws IOException {
        ...
        try {
            ...
            if (doiMetadata.getLanguage()!= null && !doiMetadata.getLanguage().isEmpty())  // MADROÑO Send Language to DataCite
                metadata.put ("datacite.language", doiMetadata.getLanguage().get(0));
