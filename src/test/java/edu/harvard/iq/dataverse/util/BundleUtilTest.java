...
public class BundleUtilTest {
    ...
    public void testGetStringFromBundle() {
        ...
        assertEquals("Search", BundleUtil.getStringFromBundle("search", true));
    }

    @Test
    public void testGetStringFromBundleWithArguments() {
        assertEquals(null, BundleUtil.getStringFromBundle(null, null));
        String actual = BundleUtil.getStringFromBundle("dataverse.create.success", Arrays.asList("http://guides.dataverse.org/en", "4.2"), true);
        String expected = "You have successfully created your dataverse! To learn more about what you can do with your dataverse, check out the <a href=\"http://guides.dataverse.org/en/4.2/user/dataverse-management.html\" title=\"Dataverse Management - Dataverse User Guide\" target=\"_blank\">User Guide</a>.";
        ...
        assertEquals("Your new dataverse named "
                ...
                + "http://guides.dataverse.org/en/4.2/user/dataverse-management.html .",
                BundleUtil.getStringFromBundle("notification.email.createDataverse",
                        Arrays.asList("dvName", "dvUrl", "parentDvName", "parentDvUrl", "http://guides.dataverse.org/en", "4.2"),true));
        assertEquals("Your new dataset named dsName (view at dsUrl ) "
                ...
                + "http://guides.dataverse.org/en/4.2/user/dataset-management.html .",
                BundleUtil.getStringFromBundle("notification.email.createDataset",
                        Arrays.asList("dsName", "dsUrl", "parentDvName", "parentDvUrl", "http://guides.dataverse.org/en", "4.2"),true));
        assertEquals("There are no dataverses, datasets, or files that match your search. "
                ...
                BundleUtil.getStringFromBundle("dataverse.results.empty.zero",
                        Arrays.asList("http://guides.dataverse.org/en", "4.2"),true));
